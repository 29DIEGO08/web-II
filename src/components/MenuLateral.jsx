...
export default function MenuLateral() {
  ...
  return (
    <aside className="w-64 min-h-screen border-r border-gray-200 flex flex-col items-center pt-10 bg-gray-50">
      ...
      {user?.role === "admin" && (
        <>
          <NavLink to="/admin/crear-evento" className={buttonStyle}>Crear Evento</NavLink>
          <NavLink to="/admin/crear-admin" className={buttonStyle}>Crear otro administrador</NavLink>
          <NavLink to="/admin/peticiones" className={buttonStyle}>Peticiones de participación</NavLink>
          <NavLink to="/acercade" className={buttonStyle}>Acerca de</NavLink>
        </>
      )}
      <button
